...
public class FindClient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 90, 340, 30));
    ...
    public void cargarTabla(){
        ...
        try {
            ...
            String SQL = "SELECT Id, Dni, Nombres, Apellidos,Telefono, Edad, Direccion, Peso, Estatura, fecha_ingreso, Suscripcion, "
                    + "Genero, Observaciones FROM clientes "
                    + where ;
            ...
            for (int i = 0; i < tbClientes.getColumnCount(); i++) {
                tbClientes.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
            }
